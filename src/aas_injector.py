...
class AASInjector:
    ...
    def inject(
        self, aas_data: Dict[str, Any], recipient_id: str, in_place: bool = True
    ) -> InjectionReport:
        """
        ...
        self._traverse_and_inject(node=target_data, path="root", watermark=watermark, report=report)
    ...
    def _traverse_and_inject(
        self, node: Any, path: str, watermark: str, report: InjectionReport
    ) -> None:
        """
    ...
    def _inject_descriptions(
        self, node: Dict, path: str, watermark: str, report: InjectionReport
    ) -> None:
        """
